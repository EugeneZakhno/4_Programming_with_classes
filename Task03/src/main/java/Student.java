/*
    03. Create a class called Student, containing the fields: last name and initials, group number, performance (array
        of five elements). Create an array of ten elements of this type. Add the ability to display last names and
        numbers of groups of students with grades equal to only 9 or 10.
